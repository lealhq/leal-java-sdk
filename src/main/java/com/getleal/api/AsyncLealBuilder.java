...
import com.getleal.api.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncLealBuilder {
     ...
     * Sets token
     */
    public AsyncLealBuilder token(String token) {
        this.token = token;
        return this;
    }

    public AsyncLealBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncLealBuilder url(String url) {
     ...
     */
    public AsyncLealBuilder timeout(int timeout) {
     ...
     */
    public AsyncLealBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncLealBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncLealBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncLealBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncLealBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncLealBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncLealBuilder addHeader(String name, String value) {
    ...
    public AsyncLeal build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new AsyncLeal(buildClientOptions());
    }
}
