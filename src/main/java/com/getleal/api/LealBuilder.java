...
public class LealBuilder {
     ...
     * Sets token
     */
    public LealBuilder token(String token) {
        this.token = token;
        return this;
    }

    public LealBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public LealBuilder url(String url) {
     ...
     */
    public LealBuilder timeout(int timeout) {
     ...
     */
    public LealBuilder maxRetries(int maxRetries) {
     ...
     */
    public LealBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public LealBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public LealBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public LealBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public LealBuilder logging(LogConfig logging) {
     ...
     */
    public LealBuilder addHeader(String name, String value) {
    ...
    public Leal build() {
        ...
        return new Leal(buildClientOptions());
    }
}
